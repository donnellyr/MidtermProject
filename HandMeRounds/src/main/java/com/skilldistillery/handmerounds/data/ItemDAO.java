...
public interface ItemDAO {
	...
	Item editItem(int id, String name, String image, int typeid, int size, int itemCondition, boolean trade, String description, Integer[] optionId);
	...
	List<DeliveryOption> listAllDeliveryOptions();
